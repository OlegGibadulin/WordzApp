...
struct Storage {
    ...
    lazy var categories: [CategoryStorage] = [
        ...
        CategoryStorage(title: "Части тела", firstColor: #colorLiteral(red: 0.738361299, green: 0.7594400048, blue: 0.3427171111, alpha: 1), secondColor: #colorLiteral(red: 0.4201669693, green: 0.8623617887, blue: 0.3448260725, alpha: 1), sentences: BodyParts),
