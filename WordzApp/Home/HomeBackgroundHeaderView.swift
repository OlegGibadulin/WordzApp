...
class HomeBackgroundHeaderView: UIView {
    ...
    func setupView() {
        ...
        self.roundCorners([.layerMinXMaxYCorner, .layerMaxXMaxYCorner], radius: 40)
        ...
        let circle1Radius = self.frame.width / 1.5
...
//        self.addSubview(imageView)
        ...
        circle1.topAnchor.constraint(equalTo: self.topAnchor, constant: customViewWidth * (-0.1)).isActive = true
        circle1.leftAnchor.constraint(equalTo: self.leftAnchor, constant: customViewWidth * (-0.2)).isActive = true
        ...
        circle2.topAnchor.constraint(equalTo: self.topAnchor, constant: customViewWidth * (-0.36)).isActive = true
